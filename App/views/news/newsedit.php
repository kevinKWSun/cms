    ...
    <div class="main-wrap" style='padding:10px;'>
        ...
        <form action="/news/edit" class="layui-form layui-form-pane" id="formrec" method="post" role="form">
			...
			<div class="layui-form-item">
				...
				<textarea class="layui-textarea" id="LAY_demo2" placeholder="必填,内容信息"><?php echo $content?></textarea>
            ...
            <div class="page-footer">
                <div class="btn-list">
                    <div class="btnlist">
                        <a class="layui-btn layui-btn-sm" lay-submit="" lay-filter="btnsubmit" data-url="/news/edit"><i class="layui-icon">&#xe61f;</i>提交</a>
